      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="prose prose-teal max-w-none space-y-8 text-teal/80">
          ...
          <section>
            ...
            <p>Drawings are ordinarily held on the 15th day of each month (beginning July 15th) at 8:00 PM EST. Where the 15th falls on a Saturday, legal holiday, or other day on which a drawing cannot be conducted, the drawing will be held on the next available business day.</p>
